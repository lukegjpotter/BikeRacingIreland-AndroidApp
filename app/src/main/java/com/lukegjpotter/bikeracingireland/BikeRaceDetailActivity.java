 ...
 * This activity is only used narrow width devices.
 * On tablet-size devices, item details are presented side-by-side with a list of items in a
 * {@link BikeRaceListActivity}.
 */
public class BikeRaceDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bikerace_detail);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
             ...
             */
            NavUtils.navigateUpTo(this, new Intent(this, BikeRaceListActivity.class));
            return true;
        }
